...
bool Combat::init()
{
	...
	myBall->setPosition(Vec2(0, 0));
	this->addChild(myBall, 1);
	//create Ai
	int num = CCRANDOM_0_1() * 15;
	auto aiBalls1 = AiBalls::createWithFileName(this, "food_b.png", 2, 1, 30);
	aiBalls1->setPosition(aiBalls1->getOriginalPosition(num));
	num = CCRANDOM_0_1() * 15;
	auto aiBalls2 = AiBalls::createWithFileName(this, "food_b.png", 2, 2, 60);
	aiBalls2->setPosition(aiBalls1->getOriginalPosition(num));
	num = CCRANDOM_0_1() * 15;
	auto aiBalls3 = AiBalls::createWithFileName(this, "food_b.png", 2, 3, 90);
	aiBalls3->setPosition(aiBalls1->getOriginalPosition(num));
	num = CCRANDOM_0_1() * 15;
	auto aiBalls4 = AiBalls::createWithFileName(this, "food_b.png", 2, 4, 120);
	aiBalls4->setPosition(aiBalls1->getOriginalPosition(num));
	num = CCRANDOM_0_1() * 15;
	auto aiBalls5 = AiBalls::createWithFileName(this, "food_b.png", 2, 5, 150);
	aiBalls5->setPosition(aiBalls1->getOriginalPosition(num));
	num = CCRANDOM_0_1() * 15;
	auto aiBalls6 = AiBalls::createWithFileName(this, "food_b.png", 2, 6, 999);
